 ...
 * @author ener2
 */
public class EjemploSeparator extends Application {
    ...
    @Override public void start(Stage stage) {
        ...
        Image cloudImage = new Image(getClass().getResourceAsStream(""));
        Image sunImage = new Image(getClass().getResourceAsStream(""));
