...
public class EjemploSlider extends Application {
    ...
    @Override  public void start(Stage stage) {
        ...
        final ImageView imagen3 = new ImageView (image);
        imagen3.setEffect(sepiaEffect);
        GridPane.setConstraints(imagen3, 0, 0);
        GridPane.setColumnSpan(imagen3, 3);
        grid.getChildren().add(imagen3);
        scene.setRoot(grid);
        ...
        opacityLevel.valueProperty().addListener((
            ...
            Number old_val, Number new_val) -> {
                imagen3.setOpacity(new_val.doubleValue());
        ...
        scaling.valueProperty().addListener((
            ObservableValue<? extends Number> ov, Number old_val, 
            Number new_val) -> {
                imagen3.setScaleX(new_val.doubleValue());
                imagen3.setScaleY(new_val.doubleValue());
